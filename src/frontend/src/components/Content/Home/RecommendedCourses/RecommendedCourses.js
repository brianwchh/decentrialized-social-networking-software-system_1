...
function RecommendedCourses(props) {
    ...
    const selectedRecommendedCourseArray =  props.selectedRecommendedCourseArray
    ...
    const handleOnClickForward = (e) => {
        ...
        const imageWidth = total_width / selectedRecommendedCourseArray.length;
        // if (windowWidth <= 800) {
    ...
    return (
        <div className='recommendedCoursesRoot' 
            ref={albumRef}
            onTouchStart={handleOnTouchStart}
            onTouchEnd={handleOnTouchEnd}
            onTouchMove={handleOnTouchMove}
        >
            {selectedRecommendedCourseArray.map((Item,index) => (
