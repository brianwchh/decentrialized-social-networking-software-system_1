...
var _require = require('../View/ItemView'),
    ItemView = _require.ItemView;

var _require2 = require('../View/ChartItemView'),
    ChartItemView = _require2.ChartItemView;
...
}, // *****************ChartItem block***************************************
{
  ...
  path: '/api/item/chart',
  // each user can only have one chart
  method: 'GET',
  options: {
    auth: 'isCurrentOrSuper'
  },
