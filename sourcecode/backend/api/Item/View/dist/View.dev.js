...
ItemView.editChart = function _callee8(req, h) {
...
ItemView.getOrderList = function _callee9(req, h) {
...
ItemView.createOrder = function _callee10(req, h) {
...
ItemView.editOrder = function _callee11(req, h) {
...
ItemView.deleteOrder = function _callee12(req, h) {
...
ItemView.createAddress = function _callee13(req, h) {
...
ItemView.getAddressList = function _callee14(req, h) {
...
ItemView.getAddressDetail = function _callee15(req, h) {
...
ItemView.editAddress = function _callee16(req, h) {
...
ItemView.deleteAddress = function _callee17(req, h) {
...
ItemView.uploadImage = function _callee18(req, h) {
  ...
  return regeneratorRuntime.async(function _callee18$(_context18) {
    while (1) {
      switch (_context18.prev = _context18.next) {
        ...
        case 60:
          _context18.prev = 60;
          _context18.t1 = _context18["catch"](49);
          console.log(_context18.t1.sqlMessage);
          errMsg = _context18.t1.sqlMessage;
          connection.release();
          return _context18.abrupt("return", {
            err: errMsg
          });
...
ItemView.deleteImage = function _callee19(req, h) {
    ...
    while (1) {
      switch (_context19.prev = _context19.next) {
        ...
        case 15:
          ...
          console.log(_context19.t0.sqlMessage);
          errMsg = _context19.t0.sqlMessage;
          connection.release();
          return _context19.abrupt("return", {
            err: errMsg
          });
        ...
        case 30:
          ...
          connection.release();
          isDeleted = _context19.t1.isDeleted;
          return _context19.abrupt("return", {
            err: _context19.t1
          });
        ...
        case 42:
          _context19.prev = 42;
          _context19.t2 = _context19["catch"](36);
          console.log(_context19.t2.sqlMessage);
          errMsg = _context19.t2.sqlMessage;
          connection.release();
          return _context19.abrupt("return", {
            err: errMsg
          });
